...
export class TestBlackPawnMoves {
    ...
    testPawnCanMoveForward() {
        ...
        const singleForward: Move = { from: positionA7, to: positionA6, isValid: true };
    ...
    testPawnCannotMoveBackward() {
        putPiece(chessboard, positionA7, pieces.blackPawn);
        const singleForward: Move = { from: positionA7, to: positionA8, isValid: true };
    ...
    testPawnInitialMove() {
        putPiece(chessboard, positionA7, pieces.blackPawn);
        const doubleForward: Move = { from: positionA7, to: positionA5, isValid: true };
    ...
    testCannotMoveTwoSquaresIfAlreadyMoved() {
        ...
        const doubleForward: Move = { from: positionC6, to: positionC4, isValid: true };
    ...
    testCannotMoveThreeSquares() {
        putPiece(chessboard, positionC6, pieces.blackPawn);
        const tripleForward: Move = { from: positionA7, to: positionA4, isValid: true };
    ...
    testPawnCannotCaptureEmptySquare() {
        putPiece(chessboard, positionA7, pieces.blackPawn);
        const diagonalCapture: Move = { from: positionA7, to: positionB6, isValid: true };
